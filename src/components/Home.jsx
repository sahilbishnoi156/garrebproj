        ...
        <main className=" bg-[#151515] text-white min-h-screen pb-40 p-10">
            ...
            <section>
                <h3 className="text-2xl flex items-center justify-start gap-2">
                    <div className="text-base bg-neutral-800 px-3 rounded-2xl">
                        {tracks.length}
                    </div>
                    My Tracks{' '}
                    <a
                        href="https://www.instagram.com/am___ak47/"
                        className="cursor-pointer hover:scale-110 duration-300 ml-8"
                        target="_blank"
                    >
                        <Image
                            src={'/instalogo.webp'}
